...
# img_2_char('Data/Lerik.jpg', chars = [' ','.','-','+','#','@'], spasing = 8, scale = 0.2,background = (255,255,255),textcolor = 'original', verbose = False, original_resolution = False, flip = True)
img_2_char('Data/Lerik.jpg', chars = [' ', '.','-','+','#', '@'], spasing = 9, scale = 0.1,background = (255,255,255),textcolor = (0,0,0), verbose = True, original_resolution = False, flip = True)
